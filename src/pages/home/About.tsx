      ...
      <div className="bg-offWhite1 mx-[-32px] py-16 px-8 flex flex-col gap-6 sm:mx-[-64px] sm:px-16 sm:py-[120px] lg:mx-[calc(calc(-100vw+1000px)/2)] lg:px-[calc(calc(100vw-1000px)/2)] lg:flex-row lg:gap-16 lg:items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-gray font text-base lg:text-xl">
            ...
            in the College of Engineering specialized in interactive
            technologies and UX.
          </p>
          <p className="text-gray font text-base lg:text-xl">
            My journey began in high school where I took three years of computer
            science and two years of networking and cybersecurity. Those
            memorable years helped me discover the true purpose of writing
            programs:{" "}
          ...
          <p className="text-gray font text-base lg:text-xl">
            Aside from school and programming, you can see me live streaming
            video games on Twitch, working out at the gym 🏋️, and playing
            basketball 🏀 or tennis 🎾 at the courts!
          </p>
        </div>
        <img
          src={about}
